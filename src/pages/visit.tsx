...
import { getVisitedCards, setFilter } from '@/store/slices/visit-slice'
import { getFilter } from '@/store/utils/selectors'
...
&nbsp;at&nbsp;
        ...
        <Button onClick={() => dispatch(setFilter(filter === 'asc' ? 'desc' : 'asc'))} variant="outline" size="icon">
