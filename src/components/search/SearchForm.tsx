  ...
  return (
    <div>
      <form onSubmit={onSubmit} className="flex items-center py-6">
        <Input name="query" autoFocus value={value} className="text-md rounded-r-none border-r-none" placeholder="Search!" type="text" onChange={e => changeQuery(e.target.value)} />
